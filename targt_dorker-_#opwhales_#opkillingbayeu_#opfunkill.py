...
def logo():
	print R+"\n|------------------------------------------------------------------|"
	print "|								   |"
        print "|    	                  ____  _____  ________    _ 		   |"
	print "|		   _  _  |_   \|_   _||_   __  |  / \		   |"
	print "|		 _| || |_  |   \ | |    | |_ \_| / _ \		   |"
	print "|		|_| || |_| | |\ \| |    |  _|   / ___ \            |"
	print "|		|_| || |_|_| |_\   |_  _| |_  _/ /   \ \_          |"
	print "|		  |_||_| |_____|\____||_____||____| |____|  	   |"
	print "|	        National Frog Agency/Central Frog Services 	   |"
	print "|								   |"
        print "|								   |" 
	print "|                DESC: Remix of d4rkd0rker.py                      |"
        print "|                NFA: ~Added multi-cntry search                    |"                             
        print "|                      Searches: Iceland, Indonesia(incl GOV)      |"
        print "|                      Faroe Islands & Norway.                     |"
	print "|               Searches: XSS, RCE, LFI/RFI & SQLI                 |"
	print "|               #OpFunKill. #OpWhales. #OpKillingBayEU	           |"	
	print "|------------------------------------------------------------------|\n"
	print W
...
domains = {'#OpKilingBay#EU #OpFunKill #OpWhales (Chose #1)':['.fo','fo','is','.is','.no','no','gov.fo','.id','id','gov.id']}
